<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO `projects`(`project_name`, `assigned_to`, `start_date`, `finish_date`, `project_status`, `user_id`) 
        VALUES ('$project_name','$emp','$start_date','$finish_date','$first','$user_id')";
...
<div class="container">
        ...
        <form action="" method="post">
            <div class="mb-3">
                ...
                <input type="text" name="project_name" class="form-control" id="exampleFormControlInput1" placeholder="Design the UI of the website" pattern="[A-Za-z ]{1,100}" title="Project name should only include letters and not exceed 100 characters" required>
            </div>
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="project_status" value="ongoing" id="flexRadioDefault1" checked disabled>
                <label class="form-check-label" for="project_status">Ongoing</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="radio" name="project_status" value="completed" id="flexRadioDefault2" disabled>
                <label class="form-check-label" for="project_status">Completed</label>
            </div>
            <br>
            <div class="buttons">
                <button type="submit" name="submit" class="btn btn-success">Add a Project</button>
                <a href="../../Project.php">
